...
class StrideSensorTx(object):
    ...
    def __init__(self, antnode, sensor_id):
        ...
        try:
            ...
            self.channel.setID(StrideSensorTx.STRIDE_SENSOR_TYPE, sensor_id, 0)
            self.channel.period = StrideSensorTx.CHANNEL_PERIOD
            self.channel.frequency = StrideSensorTx.FREQUENCY
